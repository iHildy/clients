...
const focusRing = [
  ...
  "[&:has(:focus-visible)]:tw-ring-offset-2",
  "[&:has(:focus-visible)]:tw-ring-border-focus",
  "[&:has(:focus-visible)]:tw-z-10",
];
...
const variantStyles: Record<ChipVariant, string[]> = {
  primary: [
    ...
    "[&:has(button:hover,a:hover)]:tw-bg-bg-brand-soft",
  ],
  subtle: [
    "tw-bg-bg-primary",
    ...
    "[&:has(button:hover,a:hover)]:tw-bg-bg-quaternary",
  ],
  "accent-primary": [
    ...
    "[&:has(button:hover,a:hover)]:tw-bg-bg-accent-primary-medium",
  ],
  "accent-secondary": [
    ...
    "[&:has(button:hover,a:hover)]:tw-bg-bg-accent-secondary-medium",
  ],
};
